...
class VIPRestrictedCommandsTest extends CodeCheckTestBase {
	...
	public function testOther() {
		...
		$expected_errors = array(
			...
			array( 'slug' => 'get_intermediate_image_sizes',	'level' => 'Blocker', 'description' => "Intermediate images do not exist on VIP.", 'file' => 'VIPRestrictedCommandsCheck8.inc', 'lines' => ++$line ),
		);
